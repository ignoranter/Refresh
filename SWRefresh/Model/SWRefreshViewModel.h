...
@property (nonatomic, weak) id _Nullable refreshTarget;
...
/** 进入刷新状态, source可用来区分触发刷新来源, 该值可以通过 @property beginRefreshingSource得到 */
...
/** 结束刷新状态并设置结束原因, reason可通过 @property endRefreshingReason得到 */
...
- (BOOL)hasSetTempInset; ///< return YES when calling setScrollViewTempInset;
